...
// ../../node_modules/.pnpm/@ai-sdk+openai@3.0.2_zod@4.2.1/node_modules/@ai-sdk/openai/dist/index.mjs
...
var applyPatchArgsSchema = lazySchema(() => zodSchema(z9.object({})));
...
var imageGenerationInputSchema = lazySchema(() => zodSchema(z12.object({})));
var imageGenerationOutputSchema = lazySchema(
  () => zodSchema(z12.object({ result: z12.string() }))
);
...
var webSearchInputSchema = lazySchema(() => zodSchema(z15.object({})));
...
var mcpInputSchema = lazySchema(() => zodSchema(z17.object({})));
...
//# sourceMappingURL=dist-MNKJ32WU.js.map