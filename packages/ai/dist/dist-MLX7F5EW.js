...
// ../../node_modules/.pnpm/@ai-sdk+openai@3.0.2_zod@4.2.1/node_modules/@ai-sdk/openai/dist/internal/index.mjs
...
var applyPatchArgsSchema = lazySchema(() => zodSchema(z12.object({})));
...
var localShellOutputSchema = lazySchema(
  () => zodSchema(z13.object({ output: z13.string() }))
);
...
var imageGenerationInputSchema = lazySchema(() => zodSchema(z20.object({})));
var imageGenerationOutputSchema = lazySchema(
  () => zodSchema(z20.object({ result: z20.string() }))
);
...
var mcpInputSchema = lazySchema(() => zodSchema(z21.object({})));
...
var webSearchInputSchema = lazySchema(() => zodSchema(z22.object({})));
...
// ../../node_modules/.pnpm/@ai-sdk+azure@3.0.2_zod@4.2.1/node_modules/@ai-sdk/azure/dist/index.mjs
...
//# sourceMappingURL=dist-MLX7F5EW.js.map