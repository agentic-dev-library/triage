...
import { ToolSet } from '@agentic/triage-ai';
 ...
 */
declare function createFilesystemClient(workingDirectory: string): Promise<MCPClient>;
/**
 ...
 */
declare function createInlineFilesystemClient(workingDirectory: string): Promise<MCPClient>;
/**
 * Get filesystem tools from client
 */
declare function getFilesystemTools(client: MCPClient): Promise<ToolSet>;
/**
 ...
 */
declare function createGitHubClient(): Promise<MCPClient>;
/**
 * Get GitHub tools from client
 */
declare function getGitHubTools(client: MCPClient): Promise<ToolSet>;
/**
 ...
 */
declare function createPlaywrightClient(options?: {
    headless?: boolean;
 ...
 */
declare function getPlaywrightTools(client: MCPClient): Promise<ToolSet>;
/**
 ...
 */
declare function createContext7Client(): Promise<MCPClient>;
/**
 ...
 */
declare function getContext7Tools(client: MCPClient): Promise<ToolSet>;
/**
 ...
 */
declare function createViteReactClient(options?: {
 ...
 */
declare function getViteReactTools(client: MCPClient): Promise<ToolSet>;
/**
 ...
 */
declare function createGraphQLClient(): Promise<MCPClient>;
/**
 * Get GraphQL tools from client
 */
declare function getGraphQLTools(client: MCPClient): Promise<ToolSet>;
 ...
 * });
 */
declare function initializeMCPClients(options: MCPClientOptions): Promise<MCPClients>;
/**
 * Get combined tools from all active MCP clients
 *
 * Tools are available without prefixes for simpler prompts.
 */
declare function getAllTools(clients: MCPClients): Promise<ToolSet>;
/**
 * Close all MCP clients - ALWAYS call this when done!
 */
declare function closeMCPClients(clients: MCPClients): Promise<void>;
interface AgenticTaskOptions {
 ...
 * });
 */
declare function runAgenticTask(options: AgenticTaskOptions): Promise<AgenticTaskResult>;
/**
 ...
 */
declare const VITE_REACT_TOOLS: {
...
export { type AgenticTaskOptions, type AgenticTaskResult, CONTEXT7_TOOLS, FILESYSTEM_TOOLS, GITHUB_TOOLS, type MCPClient, type MCPClientOptions, type MCPClients, PLAYWRIGHT_TOOLS, VITE_REACT_TOOLS, closeMCPClients, createContext7Client, createFilesystemClient, createGitHubClient, createGraphQLClient, createInlineFilesystemClient, createPlaywrightClient, createViteReactClient, getAllTools, getContext7Tools, getFilesystemTools, getGitHubTools, getGraphQLTools, getPlaywrightTools, getViteReactTools, initializeMCPClients, runAgenticTask };
